...
Lenguaje C gestionado por menú en el que se presenten opciones para realizar las
 siguientes operaciones sobre números enteros: 
...
- Presentar la tabla de sumar, restar, multiplicar y dividir (hasta 10) de un 
  número entero
*/
#include<stdio.h>
#include<stdlib.h>

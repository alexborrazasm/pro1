...
int main() {
    // 'double' porque en la formula pueden salir valores muy altos
    double aproximacion, real, fact; 
    int x, cnt;
    ...
    printf ("Se han realizado %d iteraciones para alcanzar el valor de "
            "e^%d = %.4f\n", cnt, x, aproximacion);

...
nombre, edad y lo que se ha gastado en cañas y en transporte durante una semana 
...
int main() {
    ...
    scanf("%d", &edad);
    printf("Introduzca usted el total de sus gastos semanales en cañas" 
           " (en euros): ");
    scanf("%f", &cañas);
    printf("Introduzca usted el total de sus gastos semanales en transporte"
            " (en euros): ");
    scanf("%f", &transporte);

...
formato, debe mostrar una tabla como la que se indica donde se recoja el % 
de su sueldo que gasta semanalmente en ocio, comida y transporte. Incluya 
...
int main() {
    char nombre[10], apellido1[15];
    float salario, ocio, comida, transporte, otros, totalGasto, salidaOcio,
     salidaComida, salidaTransporte, salidaOtros;

    printf("Introduzca su nombre y apellidos: ");
    scanf("%s %s", &nombre, &apellido1);
